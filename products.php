                        ...
                        <tbody>
                            <?php if (isset($products) && $products->num_rows > 0): ?>
                                <?php while ($row = $products->fetch_assoc()): ?>
                                    <tr>
                                        <td class="tm-product-name"><?php echo htmlspecialchars($row['nombre_producto']); ?></td>
                                        <td class="text-center"><?php echo htmlspecialchars($row['stock'] - $row['descuento']); ?></td>
                                        <td class="text-center"><?php echo htmlspecialchars($row['stock']); ?></td>
                                        <td><?php echo htmlspecialchars($row['precio']); ?></td>
                                        <td>
                                            <a href="?delete=<?php echo $row['producto_id']; ?>" class="fas fa-trash-alt tm-trash-icon" onclick="return confirm('¿Estás seguro de que deseas eliminar este producto?');"></a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else: ?>
