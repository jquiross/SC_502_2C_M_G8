...
function procesarPedido($cliente_id, $fecha_pedido, $total) {
    global $conexion;
    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            ...
            case 'procesar_pedido':
                if (isset($_POST['cliente_id']) && isset($_POST['fecha_pedido']) && isset($_POST['total'])) {
                    $pedido_id = procesarPedido($_POST['cliente_id'], $_POST['fecha_pedido'], $_POST['total']);
