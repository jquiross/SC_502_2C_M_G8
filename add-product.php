                ...
                <div class="col-12">
                    <form action="controllerProduct.php" method="POST" class="tm-edit-product-form">
                        <div class="form-group mb-2">
                            ...
                            <input id="name" name="name" type="text" class="form-control validate" placeholder="Nombre del producto" required>
                        </div>
                        <div class="form-group mb-2">
                            <label for="description" class="form-label">Descripción</label>
                            <textarea id="description" name="description" class="form-control validate" rows="2" placeholder="Descripción del producto" required></textarea>
                        </div>
                        <div class="form-group mb-2">
                            <label for="price" class="form-label">Precio</label>
                            <input id="price" name="price" type="number" step="0.01" class="form-control validate" placeholder="Precio del producto" required>
                        </div>
                        <div class="form-group mb-2">
