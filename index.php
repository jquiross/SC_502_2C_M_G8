            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" href="#!" style="font-size: 1.1rem; color: #2e2b27;">Inicio</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" style="background-color: #9B8B5C; color: #2e2b27;">
                    ...
                    <form class="d-flex" action="cart.php" method="get">
                        <button class="btn" type="submit" style="color: #2e2b27; border-color: #2e2b27;">
                            ...
                            Carrito
                            <span class="badge text-white ms-1 rounded-pill" style="background-color: #2e2b27;"><?php echo count($_SESSION['cart']); ?></span>
                        </button>
                    </form>
